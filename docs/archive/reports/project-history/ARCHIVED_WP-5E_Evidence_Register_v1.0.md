...
**Version:** v1.0
**Date:** 2026-07-13
**Placement:** docs/archive/reports/project-history/ARCHIVED_WP-5E_Evidence_Register_v1.0.md
**Supersedes:** None
...
| E-03 | "All 9 `re_meal_classes` rows now `ARRAY[...]`; `'addon'` → `ARRAY['snack']` confirmed correct" | `docs/archive/implementation/work-packages/ARCHIVED_REPO-WP-04B_Seed_Loading_v1.1.md:25` | The fix previously existed and was verified on the old main |

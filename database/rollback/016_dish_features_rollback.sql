-- Rollback: 016_dish_features_rollback.sql
-- Reverses: 016_dish_features.sql
-- RECONSTRUCTED FROM EVIDENCE (WP-5C Rollback Recovery, 2026-07-13).
--   Source of truth: the forward migration file 016_dish_features.sql (the authoritative record of exactly what
...
DROP TABLE re_engine.dish_features;

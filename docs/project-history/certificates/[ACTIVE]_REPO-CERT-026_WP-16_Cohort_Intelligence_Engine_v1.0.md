...
**Version:** v1.0
**Date:** 2026-08-03
**Placement:** docs/project-history/certificates/[ACTIVE]_REPO-CERT-026_WP-16_Cohort_Intelligence_Engine_v1.0.md
**Certifies:** docs/project-history/work-packages/[DRAFT]_WP-16_Cohort_Intelligence_Engine_v1.0.md (and its shipped increments WP-16.1 foreign-cuisine demote, WP-16.2 lifecycle_stage + real time_pressure + migrant-only overlay + per-user logs)
**Supersedes:** N/A

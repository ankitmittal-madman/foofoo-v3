-- Rollback: 005_profiles_rollback.sql
-- Reverses: 005_profiles.sql
-- RECONSTRUCTED FROM EVIDENCE (WP-5C Rollback Recovery, 2026-07-13).
--   Source of truth: the forward migration file 005_profiles.sql (the authoritative record of exactly what

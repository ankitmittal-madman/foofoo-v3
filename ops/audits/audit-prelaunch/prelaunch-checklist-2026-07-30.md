...
3. Repo-wide content search for "pre-launch", "launch checklist", "go-live", "readiness" across
   ...
   - `docs/project-history/certificates/[ACTIVE]_DOC-P3-08_Readiness_Report_v1.1.md` — read in
   ...
   - `docs/project-history/work-packages/[ACTIVE]_Engineering_Launch_Plan_v1.0.md` §6
     ...
     *repository hygiene* before starting engineering sprints (renaming a misnamed SQL file,
     ...
     the product.
   - `docs/project-history/work-packages/[ACTIVE]_Final_Evidence_Closure_v1.0.md` §10 "Release

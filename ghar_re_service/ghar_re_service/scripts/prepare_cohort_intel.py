...
def main():
    """Extract aux CSVs, train the model, then run the nutritionist/chef dish->class classifier
    (WP-17 #5) that gives full 810/810 dish->meal-class coverage."""
    ...
    print("Classifying every catalogue dish -> meal class (WP-17 nutritionist/chef rubric)...")
    from ghar_re_service.scripts import classify_dishes

    classify_dishes.main()

...
**Version:** v1.0
**Date:** 2026-08-03
**Placement:** docs/archive/implementation/work-packages/ARCHIVED_WP-20_Retire_Legacy_re_engine_Schema_v1.0.md
**Supersedes:** N/A
...
- **Step 5 (audit-rls) — DONE, and it found a real bug.** `public.re_states` came up with RLS
  ...
  `docs/archive/audits/ops/root-rls-audit/ARCHIVED_rls-audit.md` (formerly repo root). The 5 per-user tables re-homed alongside `re_states` correctly have

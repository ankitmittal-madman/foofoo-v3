-- Rollback: 009_content_junctions_rollback.sql
-- Reverses: 009_content_junctions.sql
-- RECONSTRUCTED FROM EVIDENCE (WP-5C Rollback Recovery, 2026-07-13).
--   Source of truth: the forward migration file 009_content_junctions.sql (the authoritative record of exactly what
...
DROP TABLE public.dish_combo_items;

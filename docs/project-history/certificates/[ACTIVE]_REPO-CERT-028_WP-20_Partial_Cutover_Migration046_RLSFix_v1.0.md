...
**Version:** v1.0
**Date:** 2026-08-03
**Placement:** docs/project-history/certificates/[ACTIVE]_REPO-CERT-028_WP-20_Partial_Cutover_Migration046_RLSFix_v1.0.md
...
- The 5 per-user tables' zero-policy state was confirmed **correct by design** (service-role-only,
  reproducing the old `re_engine` posture) — not a finding. Full report: `rls-audit.md` (repo root).
...
v1.0, first issue. Companion: WP-20 work package (`docs/project-history/work-packages/[DRAFT]_WP-20_Retire_Legacy_re_engine_Schema_v1.0.md`) §6; `rls-audit.md` (repo root); `database/archive/re_engine_backup_20260803/` (the full pre-cutover backup, unaffected by this partial cutover).

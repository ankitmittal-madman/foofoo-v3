...
export default function WeeklyPlan() {
  ...
  return <View style={styles.screen} testID="weekly-plan-screen"><ScrollView contentContainerStyle={styles.page} showsVerticalScrollIndicator={false}>
    ...
    <Segmented options={[t("weekdays"), t("weekend")]} value={period === "weekdays" ? t("weekdays") : t("weekend")} onChange={(value) => setPeriod(value === t("weekend") ? "weekend" : "weekdays")} testIDs={["weekly-plan-period-weekdays", "weekly-plan-period-weekend"]} />

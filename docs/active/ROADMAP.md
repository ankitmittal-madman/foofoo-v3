...
8. Run production load/soak testing and revisit Fly.io sizing.

## P3 — Product and intelligence evolution

9. Decide separately whether user-submitted text may ever enter generative processing; canonical

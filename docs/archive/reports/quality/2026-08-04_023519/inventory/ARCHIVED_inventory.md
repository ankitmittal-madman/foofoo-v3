...
_Generated 2026-08-04T02:35:19.755416+00:00 · git `ea077e7`_

**78 components discovered.**
...
| --- | --- | --- | --- | --- |
| ghar_re_core | python-package | ghar_re_core | Recommendation-engine math (frozen reference impl) | 37 |
...
| recommendations | edge-function | supabase/functions/recommendations | Supabase/Deno edge function | 10 |
...
| database/migrations | sql-migration | database/migrations | 51 SQL files | 51 |
| database/rollback | sql-rollback | database/rollback | 71 SQL files | 71 |
| database/seeds | sql-seed | database/seeds | 43 SQL files | 43 |
...
| ghar_re_core/tests/test_training_pipeline.py | test-suite | ghar_re_core/tests/test_training_pipeline.py | Existing automated tests | 0 |
| ghar_re_core/tests/test_golden_master.py | test-suite | ghar_re_core/tests/test_golden_master.py | Existing automated tests | 0 |
| ghar_re_core/tests/test_scoring_registry.py | test-suite | ghar_re_core/tests/test_scoring_registry.py | Existing automated tests | 0 |
| ghar_re_core/tests/test_cohort_intel.py | test-suite | ghar_re_core/tests/test_cohort_intel.py | Existing automated tests | 0 |
| ghar_re_core/tests/test_exploration.py | test-suite | ghar_re_core/tests/test_exploration.py | Existing automated tests | 0 |
...
| ghar_re_core/tests/test_preference.py | test-suite | ghar_re_core/tests/test_preference.py | Existing automated tests | 0 |
| ghar_re_core/tests/test_cohort_plan.py | test-suite | ghar_re_core/tests/test_cohort_plan.py | Existing automated tests | 0 |
| ghar_re_core/tests/test_comfort_hero.py | test-suite | ghar_re_core/tests/test_comfort_hero.py | Existing automated tests | 0 |

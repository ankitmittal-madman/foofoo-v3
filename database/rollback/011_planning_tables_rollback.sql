-- Rollback: 011_planning_tables_rollback.sql
-- Reverses: 011_planning_tables.sql
-- RECONSTRUCTED FROM EVIDENCE (WP-5C Rollback Recovery, 2026-07-13).
--   Source of truth: the forward migration file 011_planning_tables.sql (the authoritative record of exactly what
...
DROP TABLE public.addon_slots;
DROP TABLE public.plan_slots;
DROP TABLE public.week_plans;

...
const messages = {
  en: {
    ...
    tooMuchWork: "Too much work", missingItem: "Missing item", memberObjected: "Family said no", differentMood: "Different mood", tryAgain: "Try again", noSafeMeal: "No safe complete meal is available.",
  ...
  hi: {
    ...
    tooMuchWork: "बहुत मेहनत", missingItem: "सामान नहीं है", memberObjected: "परिवार को पसंद नहीं", differentMood: "कुछ और खाने का मन", tryAgain: "फिर कोशिश करें", noSafeMeal: "अभी कोई सुरक्षित पूरा भोजन उपलब्ध नहीं है।",
